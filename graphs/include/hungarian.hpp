...
/**
 * INF should, generally speaking, be just large enough that it never gets matched.
 * It should not be INT_MAX, due to potential overflow.
 * The correct value can be calculated using: rows * maxCellCost + 1
 * The cost minimisation is global, and therefore anything below this value could,
 * theoretically, be matched
 */
